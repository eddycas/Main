        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              const Text('• File format: AES-256 encrypted binary (.aes)'),
  ...
  Future<void> _decryptAndViewReport() async {
    ...
    try {
      ...
      FilePickerResult? result = await FilePicker.platform.pickFiles(
        ...
        dialogTitle: 'Select Encrypted Report (.aes file)',
      ...
      // Manual file extension check - must be .aes

      if (!pickedFile.name.toLowerCase().endsWith('.aes')) {

        ScaffoldMessenger.of(context).showSnackBar(

          const SnackBar(content: Text('Please select a valid .aes encrypted file')),
