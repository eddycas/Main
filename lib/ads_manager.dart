...
class CalculatorHomeState extends State<CalculatorHome> with WidgetsBindingObserver {
  ...
  // SEPARATE REWARD METHODS FOR EACH PANEL
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  ElevatedButton(
                    onPressed: isWatchingAd ? null : _watchRewardedAdForHistory, // ✅ SEPARATE METHOD
                ...
                child: Column(
                  children: [
                    ...
                    if (!premiumManager.isPremium)
                      ElevatedButton(
                        onPressed: isWatchingAd ? null : _watchRewardedAdForPremium, // ✅ SEPARATE METHOD
                        style: ElevatedButton.styleFrom(
                          backgroundColor: isWatchingAd ? Colors.grey : Colors.amber,
                          foregroundColor: Colors.black,
                          padding: const EdgeInsets.symmetric(horizontal: 24, vertical: 12),
